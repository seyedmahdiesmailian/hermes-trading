...
۱۹۱ فایل پایتون + ۴ شل‌اسکریپت + `archive/` (۱۹ پروب بازنشسته). کد زنده
...
| `backfill_sqlite.py` | بازسازی کامل `hermes_state.db` از ۳ CSV (WP4؛ CSVها فقط خوانده می‌شوند) | دستی، بعد از WP4 |
